function Footer()
{
 ...
 <div>
            <div className="mt-5 p-5 ">
                ...
                <p className="p-2">1. Testing conducted by Apple in July 2025 using AirPods Pro 3 paired with iPhone 16 with pre-release AirPods firmware and iOS 26. Noise reduction was tested in accordance with IEC 60268-24. Comparison made against the best-selling wireless in-ear headphones commercially available at the time of testing. Performance depends on device settings, environment and many other factors.</p>
                <p className="p-2">Apple Intelligence is available in beta. Some features may not be available in all regions or languages. For feature and language availability and system requirements, see <u>support.apple.com/121115.</u></p>
                <p className="p-2">A subscription is required for Apple TV+.</p>
                <p className="p-2 border-solid border-gray-400 border-b-2">Features are subject to change. Some features, applications and services may not be available in all regions or all languages.</p>
            </div>
            <div className="flex justify-between mt-5 gap-2 cursor-pointer p-5">
                <div>
                    <h3 className="font-semibold">Shop and Learn</h3>
                    <ul>
                        <li className=" text-gray-400 hover:underline">Store</li>
                        <li className=" text-gray-400 hover:underline">Mac</li>
                        <li className=" text-gray-400 hover:underline">iPad</li>
                        <li className=" text-gray-400 hover:underline">iPhone</li>
                        <li className=" text-gray-400 hover:underline">Watch</li>
                        <li className=" text-gray-400 hover:underline">AirPods</li>
                        <li className=" text-gray-400 hover:underline">Tv & Home</li>
                        <li className=" text-gray-400 hover:underline">AirTag</li>
                        <li className=" text-gray-400 hover:underline">Accessories</li>
                        <li className=" text-gray-400 hover:underline">Gift Cards</li>
                    </ul>
                    <h3 className="font-semibold">Apple Wallet</h3>
                    <ul>
                        <li className=" text-gray-400 hover:underline">Wallet</li>
                    </ul>
                </div>
                <div>
                    <h3 className="font-semibold">Account</h3>
                    <ul>
                        <li className=" text-gray-400 hover:underline">Manage Your Apple Account</li>
                        <li className=" text-gray-400 hover:underline">Apple Store Account</li>
                        <li className=" text-gray-400 hover:underline">iCloud.com</li>
                    </ul>
                    <h3 className="font-semibold">Entertainment</h3>
                    <ul>
                        <li className=" text-gray-400 hover:underline">Apple One</li>
                        <li className=" text-gray-400 hover:underline">Apple TV+</li>
                        <li className=" text-gray-400 hover:underline">Apple Music</li>
                        <li className=" text-gray-400 hover:underline">Apple Arcade</li>
                        <li className=" text-gray-400 hover:underline">Apple Podcasts</li>
                        <li className=" text-gray-400 hover:underline">Apple Books</li>
